...
pnpm --dir "$EX" exec fireline-v3-dev \
  ...
  env FIRELINE_ENDPOINT="http://127.0.0.1:7714/v1/stream/fireline-vercel-edge-fresh" \
...
```sh
export EX=/Users/gnijor/gurdasnijor/fireline-examples
env FIRELINE_ENDPOINT="http://127.0.0.1:7715/v1/stream/fireline-vercel-edge-reuse" \
